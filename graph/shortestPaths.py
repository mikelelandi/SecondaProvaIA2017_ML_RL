...
def FloydWarshall_ADJ(graph):
    """
    Floyd-Warshall's algorithm for the computation of the shortest path.
    The algorithm assumes a graph implemented as adjacency list.
    ---
    Time Complexity: O(|V|^3)
    Memory Complexity: O()
...
if __name__ == "__main__":
    ...
    print("FloydWarshall_ADJ:")

    distances = FloydWarshall_ADJ(graph2)
